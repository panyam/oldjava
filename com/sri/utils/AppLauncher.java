 ...
 * the AppLauncher class can "request" to be loaded by this process.
 *
...
public class AppLauncher
{
    ...
    public AppLauncher(int port)
    {
         ...
         *
         * This is called, when an application calls "AppLauncher.launch"
         * by itself rather than be called by the user.
         *
         * This would be useful, if the user does not know about
         * AppLauncher objects but the application knows about it.
         *
        ...
        while (!launched)
        {
            ...
            } else
            {
                try
                {
                    ...
                    AppLauncher.go(className, funcName, args);
    ...
    {
        System.err.println("Usage: AppLauncher <options> " +
    ...
    public static void main(String[] args)
    {
        ...
        AppLauncher l = new AppLauncher(portNum);
