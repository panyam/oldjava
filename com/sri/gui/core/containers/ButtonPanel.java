 ...
 */
public class ButtonPanel extends SContainer
                          implements Runnable, ComponentListener
{
    ...
    public void addImpl(Component c,Object constraints, int index)
    {
         ...
         * Adds a new item.
         */
    public void addItem(SActionButton button, Component comp)
    {
        ...
        button.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent e)
            {
                ...
                {
                    int index = getControllerIndex((SActionButton)src);
    ...
    public Component getComponent(int which)
    {
         ...
         * Returns the component at the given index.
         */
    public SActionButton getController(int which)
    {
        return (SActionButton)super.getComponent(getComponentCount() + which);
    }
    
    public void removeItem(SActionButton button)
    {
    }
    ...
    public Dimension getPreferredSize()
    {
        ...
        for (int i = 0;i < nc;i++)
        {
            ...
            SActionButton btn = getController(i);
         ...
         */
    public int getControllerIndex(SActionButton btn)
    {
        int nc = getComponentCount();
        for (int i = 0;i < nc;i++)
        {
