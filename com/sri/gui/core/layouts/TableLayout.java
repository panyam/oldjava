...
public class TableLayout implements LayoutManager2, java.io.Serializable {
    ...
    /**
     * construct a TableLayout with specified number of columns
     ...
     */
    public TableLayout(int cols, int padx, int pady) {
	this.cols = cols;
	this.padx = padx;
	this.pady = pady;
    }
    ...
    /*
     * construct a TableLayout from a constraint string.
     * Usage:
   ...
   void bindContainer(Container target){
    ...
    public int getRows(){
	if (!valid){
	    throw new RuntimeException("TableLayout not valid");
	}
	return rows;
    }
    ...
    /**
     * @return the String representation of this TableLayout's values.
     */
